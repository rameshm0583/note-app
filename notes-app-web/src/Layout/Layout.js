...
import { LabelsRoute, HomeRoute } from '../Routing';
        ...
        const drawer = (
            <div id="drawer-container">
                ...
                <List>
                    ...
                    <Divider />
                    <ListItem button component={Link} to={LabelsRoute} onClick={mobileOpen ? this.handleDrawerToggle : null}>
                        <ListItemIcon>
                    ...
                    <MuiThemeProvider theme={theme}>
                        <div className={classes.root} >
                            ...
                            <main className={classes.content}>
                                ...
                                <Box width="100%" className="mainContent"><Typography variant='h1'>{this.props.children}</Typography></Box>
                            </main>
                        </div>
                    </MuiThemeProvider>
                </div>
